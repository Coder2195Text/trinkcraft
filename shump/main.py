...
def draw_shield_bar(surf, x, y, pct):
    ...
    pygame.draw.rect(surf, (49, 21, 90), outline_rect, 3)
...
class Mob(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.top > HEIGHT + 10 or self.rect.left < -25 or self.rect.\
                right > WIDTH + 20:
            self.rect.x = random.randrange(WIDTH - self.rect.width)
...
while running:
    ...
    hits = pygame.sprite.spritecollide(player, mobs, True, pygame.sprite.
                                       collide_circle)
    for hit in hits:
